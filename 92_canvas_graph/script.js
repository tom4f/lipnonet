...
const loadPocasiAsync = async () => {
    ...
    //
    voda    = new Draw('voda'   , 'white', canvas1, 'left' , canvas1_pointer, null   , 'Teplota vody [\xB0C]', dateStorage);
    vzduch  = new Draw('vzduch' , 'green', canvas1, 'right', canvas1_pointer, 'voda' , 'Teplota vzduchu ráno [\xB0C]', dateStorage);
    //
    odtok   = new Draw('odtok'  , 'white', canvas2, 'left' , canvas2_pointer, null   , 'Odtok [m\xB3/s]', dateStorage);
