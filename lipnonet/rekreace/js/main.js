...
//const photoUrlPath = thisPageUrl.includes('localhost') ? 'fotogalerie/' : '../../rekreace/fotogalerie/';
...
class UI {
    ...
    static imgClick(event) {
      ...
      bigImgBlock.style.backgroundImage = "url('" + divUrl + "')";
      //current.src = divUrl;
